package com.prac.jwt_prac.util;
...
public class JwtUtil {
	...
	private final String SECRET_KEY = "qwertyuiopasdfghjklzxcvbnmasdfghjklqwertyuioasdfghjklzxcvbnmqwertyuiosdfghjkxcvbnwertyuisdfghj";
